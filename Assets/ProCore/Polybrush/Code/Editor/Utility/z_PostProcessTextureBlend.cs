...
namespace Polybrush
{
	...
	public class z_PostProcessTextureBlend : AssetPostprocessor
	{
		...
		public const string BLEND_SRC_SUFFIX = "_SfTexBlendSrc";
		...
		{
			string blendShaderPath = importedAssets.FirstOrDefault(x => x.EndsWith(BLEND_SRC_SUFFIX + ".shader"));
		...
		static void ProcessShader(string path)
		{
			...
			string header = string.Format("// {1}{0}// {2}{0}// Important!  This is a generated file, any changes will be overwritten{0}// when the _TexBlendSrc suffixed version of this shader is modified.{0}{0}",
