...
#define GLITTER_AMPLIFY 10000.0
#define GLITTER_SMOOTHNESS_GAIN_LIMIT 0.2
...
#if !defined(WET_FLOW)
	// undef to get animated ripples that don't follow surface slope direction
	#define WET_FLOW
#endif
