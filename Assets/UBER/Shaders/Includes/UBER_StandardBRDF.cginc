...
//	float mip = pow(roughness,3.0/4.0) * UNITY_SPECCUBE_LOD_STEPS;
	// UBER - this approx might be a bit faster (however the same num of ALUs reported)
	float mip = (-0.2675967907 * UNITY_SPECCUBE_LOD_STEPS) * log2(roughness*0.065+0.01) * roughness;
#endif
